...
impl Encoding {
    ...
    pub fn get_word_ids(&self) -> &[Option<usize>] {
        &self.words
    }

    pub fn get_word_ids_mut(&mut self) -> &mut [Option<usize>] {
        &mut self.words
    }
    ...
    pub fn word_to_tokens(&self, word: usize, sequence_id: usize) -> Option<(usize, usize)> {
    ...
    pub fn word_to_chars(&self, word: usize, sequence_id: usize) -> Option<Offsets> {
    ...
    pub fn token_to_word(&self, token: usize) -> Option<(usize, usize)> {
        Some((
            self.token_to_sequence(token)?,
    ...
    pub fn char_to_word(&self, pos: usize, sequence_id: usize) -> Option<usize> {
        Some(
...
impl std::iter::FromIterator<(u64, String, (usize, usize), Option<usize>, u64)> for Encoding {
    fn from_iter<I: IntoIterator<Item = (u64, String, (usize, usize), Option<usize>, u64)>>(
        iter: I,
    ) -> Self {
